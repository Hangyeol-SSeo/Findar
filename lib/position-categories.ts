// 순서 = 매칭 우선순위(첫 매치가 채택됨). "퀀트 개발자"처럼 여러 규칙에 걸치는
// 직무명이 있으므로, 더 구체적인 카테고리를 IT/개발·영업 같은 넓은 카테고리보다 앞에 둔다.
const CATEGORY_RULES: [string, string[]][] = [
  ["퀀트", ["퀀트", "Quant", "정량", "알고리즘트레이딩"]],
  ["WM/PB", ["WM", "PB", "프라이빗뱅커", "자산관리"]],
